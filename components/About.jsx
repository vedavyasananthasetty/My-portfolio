    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-10'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-2 text-gray-600'>
            I'm passionate about staying up-to-date with the latest trends and technologies in the field, and constantly strive to improve my skills through ongoing learning and development.
          </p>
          <p className='py-2 text-gray-600'>
            Whether I'm working on a new project or troubleshooting a challenging issue, I approach each task with a dedication to excellence and a commitment to delivering results. If you're looking for a talented Full Stack Developer who can help you bring your ideas to life, <span className='text-rose-600 underline cursor-pointer'>let's connect!</span> 
          </p>
          <Link href='/#projects'>
